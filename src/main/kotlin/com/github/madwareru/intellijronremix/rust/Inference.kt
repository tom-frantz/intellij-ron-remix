...
import org.rust.lang.core.thir.indexOfField
...
private class InferenceBuilder(
    ...
    private fun findNamesInGlobalScope(name: NormalizedName, project: Project) =
        RsNamedElementIndex.Helper.findElementsByName(project, name.indexedName, GlobalSearchScope.allScope(project))
